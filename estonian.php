<?php return array (
  ...
  array (
    ...
    array (
      ...
      'Upload, Delete, Rename, etc.' => 'Lae üles, kustuta, nimeta ümber jne.',
      'Download, Preview, Copy, etc.' => 'Lae alla, vaata eelvaaded, kopeeri jne.',
      'Versioning' => 'Versioon',
      ...
      'Folder Activity' => 'Kausta tegevuslogi',
    ...
    array (
      ...
      'Please do not use question marks (?) for the new password.' => 'Palun ärge kasutage uues salasõnas küsimärke (?).',
      'Please retype the new password correctly.' => 'Palun sisestage uus parool korrektselt.',
      'The new password is the same as the current one.' => 'Uus parool on sama, mis praegune.',
      'Please type your name' => 'Palun sisestage enda nimi',
