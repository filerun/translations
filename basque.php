<?php return array (
  ...
  array (
    ...
    array (
      ...
      'Upload, Delete, Rename, etc.' => 'Kargatu, Ezabatu, Izena aldatu, etab.',
      'Download, Preview, Copy, etc.' => 'Jaitsi, Aurrebista, Kopia, etab.',
    ...
    array (
      ...
      'Please do not use question marks (?) for the new password.' => 'Mesedez, ez erabili galdera zeinurik (?) pasahitz berrirako.',
      'Please retype the new password correctly.' => 'Mesedez tekleatu berriro zuzen pasahitz berria.',
      'The new password is the same as the current one.' => 'Pasahitz berria oraingoaren berdina da.',
    ),
    'E-mail Files' => 
    array (
