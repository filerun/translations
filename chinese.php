...
',
      ...
      'Path to ImageMagick "convert" binary' => 'ImageMagick "转化" 二进制路径',
      'Generate ImageMagick thumbnails for the following file types' => '为以下文件类型生成ImageMagick 缩略图',
      ...
      'Default sender e-mail address' => '默认发送者电子邮件地址',
...
',
    ...
    array (
      ...
      'Details' => '详细',
      'Keyword' => '关键字',
      'The search results have been saved to your home folder as "%1"' => '搜索结果已经作为"%1"保存到您的主目录',
...
',
    ...
    array (
      ...
      'ONLYOFFICE server URL' => 'ONLYOFFICE服务器URL',
