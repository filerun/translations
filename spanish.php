<?php return array (
  ...
  array (
    ...
    array (
      ...
      'Upload, Delete, Rename, etc.' => 'Cargar, Eliminar, Renombrar, etc.',
      'Download, Preview, Copy, etc.' => 'Descargar, Previsualizar, Copiar, etc.',
      ...
      'Folder Activity' => 'Actividad en carpeta',
      ...
      'Search in' => 'Buscar en',
      'Index files' => 'Indice de ficheros',
    ...
    array (
      ...
      'Please do not use question marks (?) for the new password.' => 'Por favor, no use símbolos de interrogación (?) para la nueva clave.',
      'Please retype the new password correctly.' => 'Por favor vuelva a teclear correctamente la nueva clave.',
      'The new password is the same as the current one.' => 'La nueva clave es idéntca a la actual.',
...
%2 por <span style="color:black">%1</span>',
      ...
      'No activity records found for this folder' => 'No se encontraron registros para esta carpeta',
    ),
    'Metadata' => 
    array (
    ...
    array (
      ...
      'Groups' => 'Grupos',
      'Image preview' => 'Vista previa y miniaturas',
    ...
    array (
      ...
      'Show media library' => 'Mostrar librerías de medios',
      ...
      'Path to ImageMagick "convert" binary' => 'Ruta al programa "convert" de ImageMagick',
      'Generate ImageMagick thumbnails for the following file types' => 'Generar miniaturas de ImageMagick para los siguientes tipos de ficheros',
      ...
      'Default sender e-mail address' => 'Dirección e-mail de envio por defecto',
      ...
      'Photos thumbnail size' => 'Tamaño de miniatura de imágenes',
...
{ADMUSERNAME} será sustituido con este nombre de usuario',
    ...
    array (
      ...
      'The search results have been saved to your home folder as "%1"' => 'Los resultados de la búsqueda han sido guardados en su carpeta de inicio como "%1"',
...
<strong>%1</strong>, desde %4, descargó el fichero"<strong>%2</strong>" (<em>%3</em>).',
    ...
    array (
      ...
      'ONLYOFFICE server URL' => 'URL servidor ONLYOFFICE',
